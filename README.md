...
**Description Line (GitHub About Section):**  
Hybrid application for chemical equipment analytics using Django, React & PyQt with CSV processing, charts and PDF reports.
...
1. `Initial project setup – Django + React + PyQt structure`
2. `Added CSV upload API with Pandas analytics`
3. `Implemented React dashboard with Chart.js`
4. `Added PyQt desktop client with Matplotlib`
5. `PDF report generation integrated`
6. `Final UI improvements and README`
```
